...
const CreateUser = () => {
  ...
  // const [department, setDepartment] = useState(IN_Form);
  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8 w-full max-w-6xl mx-auto">
      ...
      <div className="bg-card border rounded-md shadow-sm py-6">
        <form
        ...
        >
          ...
          <div className="space-y-4">
            <h2 className="text-base font-semibold border-b pb-2">Address</h2>
