  ...
  return (
    <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-8 w-full max-w-6xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-semibold text-foreground capitalize">Update Branch Admin</h1>
      </div>

      <div className="bg-card border border-border rounded-md py-6 shadow-sm">
        <form onSubmit={handleSubmit} className="max-w-3xl w-full mx-auto space-y-8 px-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <Input name="aadharCard" value={form.aadharCard} onChange={handleChange}
                  className="h-11 w-full bg-background border-border text-foreground placeholder:text-muted-foreground"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="col-span-1 sm:col-span-2 lg:col-span-3">
                ...
                <Input name="lane" value={form.lane} onChange={handleChange}
                  className="h-11 w-full bg-background border-border text-foreground placeholder:text-muted-foreground"
          ...
          <div className="flex justify-center pt-2 pb-6">
            <Button type="submit" className="max-w-xs w-full py-5 text-base capitalize">
              Update Branch Admin
            </Button>
          </div>
